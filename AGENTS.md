...
This file is the quick-reference operating contract for include-dir-kotlin. The longer
...
include-dir-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`include_dir`](https://crates.io/crates/include_dir). Upstream Rust is the behavioral oracle while the
