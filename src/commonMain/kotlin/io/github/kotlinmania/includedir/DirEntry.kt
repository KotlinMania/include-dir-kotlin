...
sealed class DirEntry {
    /** A directory. */
    data class Dir(val value: io.github.kotlinmania.includedir.Dir) : DirEntry()

    /** A file. */
    data class File(val value: io.github.kotlinmania.includedir.File) : DirEntry()
    ...
    fun children(): List<DirEntry> = when (this) {
