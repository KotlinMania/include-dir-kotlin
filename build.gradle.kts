...
kotlin {
    ...
    swiftExport {
        moduleName = "IncludeDir"
        flattenPackage = "io.github.kotlinmania.includedir"
    }

    android {
        namespace = "io.github.kotlinmania.includedir"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "include-dir-kotlin", version.toString())

    pom {
        name.set("include-dir-kotlin")
        description.set("Kotlin Multiplatform port of Michael-F-Bryan/include_dir - Embed the contents of a directory in your binary")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/include-dir-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/include-dir-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/include-dir-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/include-dir-kotlin.git")
        }
    }
}
...
// commonMain Kotlin sources through the CodeQL Java agent without relying on
// the Kotlin Multiplatform compile pipeline.
